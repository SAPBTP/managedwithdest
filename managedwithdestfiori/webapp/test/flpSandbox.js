		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "App Title",
									"targetURL": "#managedwithdestfiori-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"managedwithdestfiori-display": {
								"semanticObject": "managedwithdestfiori",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=managedwithdestfiori",
									"url": sap.ui.require.toUrl("managedwithdestfiori")
								}
							}
						}
					}
